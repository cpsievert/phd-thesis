...
Maintaining a general purpose interactive graphing toolkit like
\textbf{plotly} requires lots of up-keep and maintenance in order to be
practically useful. Aside from things like bug fixes and improving its
ability to work well with other software (e.g.~embedding plots in new
computing environments like IPython/Jupyter notebooks, nteract, etc),
there are a number of potential projects that would be interesting from
...
\item
  Apply the existing infrastructure in \textbf{plotly} to address a
  domain-specific visualization problem.
\end{enumerate}
