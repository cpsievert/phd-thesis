...
\caption{\label{fig:highlight-boxplot}Brushing a scatterplot to}
\end{figure}
...
we can see that (obviously) displacment is related with to the number of
cylinders.
...
\centering
\includegraphics{images/highlight-boxplot.pdf}
\caption{\label{fig:highlight-bars}Brushing a scatterplot to}
\end{figure}
...
\StringTok{      gd.on('plotly_click', function(d) \{}
