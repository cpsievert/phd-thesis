...
\includegraphics[width=26.28in]{images/eechidna-diff}
\textbackslash{}caption\{Electorates that were determined by less than
10\% of the total vote. These electorates tend to have voters that are
younger, less religious, are less likely to own property, and lean
towards the Labor party.\}\label{fig:eechidna-diff}
