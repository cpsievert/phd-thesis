...
While tidy tools are generally useful for many common data analysis
tasks, sometimes it's necessary to work with messy (i.e.,
...
tasks can be solved with tidy tools while 20\% require other tools.
Probably the most common non-tidy data structure in R is a nested list
which is the most flexible and reliable way to represent web-based data
structures, such as JSON and XML, in R.
