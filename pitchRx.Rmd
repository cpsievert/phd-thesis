...
\texttt{scrape} is presented in Table~\ref{table:pitchfx}. The \texttt{pitch}
...
\textbf{XML nodes}  														&
\textbf{\begin{tabular}[c]{@{}c@{}} Tables returned\\ by \texttt{scrape} \end{tabular}} \\ 
  	\midrule     
\texttt{miniscoreboard.xml} & game-by-game  & \begin{tabular}[c]{@{}c@{}} games, game, \\ game\_media, media \end{tabular}  & game, media   \\[12pt]
	\midrule 
\texttt{players.xml} & game-by-game & \begin{tabular}[c]{@{}c@{}} game, team, player, \\ coach, umpire \end{tabular}  & 
\begin{tabular}[c]{@{}c@{}} player, coach, \\ umpire \end{tabular}            \\[12pt]
	\midrule 
\texttt{inning\_all.xml} & \begin{tabular}[c]{@{}c@{}} play-by-play, \\ pitch-by-pitch  \end{tabular}  & 
...
\begin{tabular}[c]{@{}c@{}} atbat, po, pitch, \\ runner, action \end{tabular}    \\[18pt]
	\midrule 
\texttt{inning\_hit.xml} & play-by-play  & hitchart, hip  & hip     \\   
		\bottomrule   
	\end{tabular} 
	\caption{Structure of PITCHf/x and related Gameday data sources accessible to \texttt{scrape}}
	\label{table:pitchfx} 
\end{widetable}
-->
...
knitr::include_graphics("images/Drawing1.pdf")
```
...
knitr::include_graphics("images/prob-strike.pdf")
```
...
knitr::include_graphics("images/ani-frame1.pdf")
```
...
knitr::include_graphics("images/ani-frame2.pdf")
```
...
knitr::include_graphics("images/rgl_b.png")
knitr::include_graphics("images/rgl_a.png")
```
