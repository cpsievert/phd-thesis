...
3. Integrate the current infrastructure in **plotly** with **ggplot2** extension packages. A particularly intriguing example would be the **GGally** package [@GGally]. 

1. Apply and/or build upon the existing infrastructure in **plotly** to address domain-specific visualization problem(s). This could be anything from the 
...
4. Retrieve the state of an interactive visualization. The `highlight()` function does provide a 
