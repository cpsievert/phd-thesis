...
All software interfaces (graphical or not) are fundamentally _user_ interfaces. Especially with respect to data analysis, any attempt to measure the quality of a software interface should be largely based on its effectiveness in aiding users complete their task at hand, but as @Unwin:1999vp says, "There is a tendency to judge software by the most powerful tools they provide (whether its a good interface or not), rather than by whether they do the simple things well". With respect to programming interfaces, this type of thinking fails to consider the cognitive burden users experience when shifting between their primary task (data analysis) and unimportant implementation details.

<!-- TODO: talk about the tidyverse! -->
