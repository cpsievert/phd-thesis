...
Our ability to find interesting structures in high-dimensional data is fundamentally limited by the 2D display of a computer screen (or paper). As [@Wilhelm:2008jb] points out, there are four main workarounds to this limitation:

1. virtual reality
2. dimension reduction (principal component analysis, projection pursuit, multidimensional scaling, correspondence analysis)
3. graphics with a non-orthogonal coordinate system (e.g., parallel coordinate plots)
4. linking low-dimensional displays (two or more plots share information with each other)

The statistical graphics community has done a lot of work in (2)-(4).
