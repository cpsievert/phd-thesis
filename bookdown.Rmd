...
This chapter contains many web-based interactive graphics and moving images. It is best viewed in its web-based form here -- <https://cpsievert.github.io/plotly_book/>
...
```{r summary, fig.cap = "First, second, and third quartile of median monthly house pirce in Texas."}
